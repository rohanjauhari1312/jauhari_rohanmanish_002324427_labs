...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewProductDetailJPanel(JPanel workArea, Product product, boolean sf ) {
        initComponents();
...
int price=1;
        ...
        if (stringPrice.isEmpty() == false) {
            ...
            if (price<0)
            {
                JOptionPane.showMessageDialog(this, "Price is negative", "Warning", JOptionPane.WARNING_MESSAGE) ;
                return;
            }
        }
        }
        catch(NumberFormatException e){
                JOptionPane.showMessageDialog(this, "Price is not a number", "Warning", JOptionPane.WARNING_MESSAGE) ;
            return;
            }
        ...
        btnAddFeature.setEnabled (false) ;
        btnRemoveFeature.setEnabled (false) ;
        JOptionPane.showMessageDialog (this,"Product saved","Information", JOptionPane.INFORMATION_MESSAGE);
        refreshTable();
