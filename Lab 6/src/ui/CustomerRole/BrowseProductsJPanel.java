...
JPanel userProcessContainer;
    ...
    public BrowseProductsJPanel( JPanel jp,SupplierDirectory sd, MasterOrderList mo) {
        initComponents();
      this.userProcessContainer = jp;
        this.supplierDirectory = sd;
        this. masterOrderList = mo;
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        userProcessContainer.add("View0rderItemDetailJPanel", voidp);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
